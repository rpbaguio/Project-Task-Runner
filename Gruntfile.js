module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    /* Clean */
    clean: {
      scss: ['build/scss/css', 'release/scss/css'],
      less: ['build/less/css', 'release/less/css'],
      stylus: ['build/stylus/css', 'release/stylus/css']
    },
    ...
    copy: {
      scss: {
        ...
        cwd: 'build/scss/css',
        src: ['**'],
        dest: 'release/scss/css'
      },
      less: {
        expand: true,
        cwd: 'build/less/css',
        src: ['**'],
        dest: 'release/less/css'
      },
      stylus: {
        expand: true,
        cwd: 'build/stylus/css',
        src: ['**'],
        dest: 'release/stylus/css'
      }
    },
